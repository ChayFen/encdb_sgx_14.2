...
explain analyze select count(*) from stu where id>100;

select pg_backend_pid();

select count(*) as district1 from district1;
select count(*) as history1 from history1;
select count(*) as item1 from item1;
select count(*) as new_orders1 from new_orders1;
select count(*) as order_line1 from order_line1;
select count(*) as orders1 from orders1;
select count(*) as stock1 from stock1;
